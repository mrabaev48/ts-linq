...
describe('Decorators', () => {
    ...
    describe('Relationship decorators', () => {
        it('should register one-to-many relationship', () => {
            ...
            const userTargetEntity = typeof userMetadata!.relationships[0].targetEntity === 'function' ? 
                userMetadata!.relationships[0].targetEntity() : userMetadata!.relationships[0].targetEntity;
            ...
            const postTargetEntity = typeof postMetadata!.relationships[0].targetEntity === 'function' ? 
                postMetadata!.relationships[0].targetEntity() : postMetadata!.relationships[0].targetEntity;
