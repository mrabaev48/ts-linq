...
`DbSet` (604 LOC, 35 methods) is the last remaining god class. `Queryable`, `DbContext`, and `CacheCoordinator` concerns have all been extracted into focused collaborators.
