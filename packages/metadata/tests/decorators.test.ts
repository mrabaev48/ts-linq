...
import { ManyToMany, ManyToOne, OneToMany, OneToOne } from '../src/Relationships';
import {
  MaxLengthOf,
  MinLengthOf,
  PatternOf,
...
describe('Decorators', () => {
  ...
  describe('@ComputedColumn', () => {
    it('should register computed column', () => {
      ...
      ComputedColumn({ expression: 'CONCAT(firstName, " ", lastName)' })(
        User.prototype,
        'fullName'
      );
  ...
  describe('Validation decorators', () => {
    ...
    it('@RequiredIfOf should validate conditional requirement', () => {
      ...
      RequiredIfOf((entity: any) => entity.isPaid, 'Payment details required')(
        Order.prototype,
        'paymentMethod'
      );
