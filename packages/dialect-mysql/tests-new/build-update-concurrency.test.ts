...
describe('MysqlDialect — buildUpdate with concurrency tokens', () => {
  test('isConcurrencyToken injects AND col = ? with original value', () => {
...
describe('MysqlDialect — buildDelete with concurrency tokens', () => {
  test('isConcurrencyToken appends AND col = ?', () => {
    const titleCol: ColumnMetadata = {
      propertyName: 'title',
      columnName: 'title',
      type: 'TEXT',
