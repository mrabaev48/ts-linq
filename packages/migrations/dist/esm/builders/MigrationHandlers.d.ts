...
export declare function buildIndexColumnsList(dialect: Dialect, columns: string[], orders?: {
...
export declare function handleColumnChanges(td: TableDiff, dialect: Dialect, up: string[], down: string[]): void;
export declare function buildCreateIndexSql(dialect: Dialect, table: string, idx: {
    name: string;
    columns: string[];
    unique?: boolean;
    where?: string;
...
export declare function buildIndexUsing(dialect: Dialect, using?: 'btree' | 'hash' | 'gin' | 'gist'): string;
export declare function buildIndexConcurrently(dialect: Dialect, concurrently?: boolean): string;
export declare function buildIndexWithParams(dialect: Dialect, withParams?: Record<string, string | number | boolean>): string;
export declare function buildIndexVisibility(dialect: Dialect, visibility?: 'VISIBLE' | 'INVISIBLE'): string;
export declare function buildIndexInclude(dialect: Dialect, include?: string[]): string;
export declare function handleAddColumnChange(dialect: Dialect, td: TableDiff, ch: {
    kind: 'add';
    column: ColumnDef;
}, up: string[], down: string[]): void;
export declare function handleAlterColumnChange(dialect: Dialect, td: TableDiff, ch: {
    kind: 'alter';
    column: ColumnDef;
    prev?: ColumnDef;
}, up: string[]): void;
export declare function handleDropColumnChange(dialect: Dialect, td: TableDiff, ch: {
    kind: 'drop';
    column: ColumnDef;
}, up: string[]): void;
