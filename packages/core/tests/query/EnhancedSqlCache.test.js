...
describe('EnhancedSqlCache', () => {
  ...
  const resetCache = (options) => {
    ...
    cache = new EnhancedSqlCache_1.EnhancedSqlCache(options);
  };
  const testEntry = {
  ...
  describe('Resource Management', () => {
    test('should dispose resources properly', () => {
      ...
      const testCache = new EnhancedSqlCache_1.EnhancedSqlCache(options);
...
//# sourceMappingURL=EnhancedSqlCache.test.js.map
