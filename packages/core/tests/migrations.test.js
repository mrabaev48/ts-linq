...
const Migration_1 = require("../src/migrations/Migration");
const MigrationRunner_1 = require("../src/migrations/MigrationRunner");
const sqlite_1 = require("@ts-linq/sqlite");
class TestMigration001 extends Migration_1.Migration {
    async up() {
...
class TestMigration002 extends Migration_1.Migration {
    async up() {
        await this.provider.executeNonQuery(`
...
describe('Migrations', () => {
    ...
    beforeEach(async () => {
        ...
        migrationRunner = new MigrationRunner_1.MigrationRunner(provider);
    });
    afterEach(async () => {
    ...
    describe('MigrationRunner', () => {
        it('should create migration table', async () => {
            ...
            const result = await provider.executeQuery('SELECT name FROM sqlite_master WHERE type="table" AND name="__migrations"');
        ...
        it('should handle migration failures with rollback', async () => {
            class FailingMigration extends Migration_1.Migration {
                constructor() {
                    super(...arguments);
                    this.name = 'FailingMigration';
                    this.version = '003';
                }
                async up() {
            ...
            await expect(migrationRunner.migrate()).rejects.toThrow('Failed to apply migration FailingMigration');
