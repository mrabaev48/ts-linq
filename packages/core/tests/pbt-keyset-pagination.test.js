...
describe('Property-based: keyset pagination correctness', () => {
    test('monotonic keyset yields contiguous, non-duplicated chunks', () => {
        fast_check_1.default.assert(fast_check_1.default.property(fast_check_1.default.array(fast_check_1.default.integer({ min: -1000, max: 1000 }), { minLength: 0, maxLength: 200 }), fast_check_1.default.integer({ min: 1, max: 20 }), (data, pageSize) => {
