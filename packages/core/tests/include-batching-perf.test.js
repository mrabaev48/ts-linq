...
], PerfAuthor.prototype, "id", void 0);
__decorate([
    (0, Column_1.Column)({ type: 'TEXT', nullable: false }),
    __metadata("design:type", String)
], PerfAuthor.prototype, "name", void 0);
__decorate([
    (0, Relationships_1.OneToMany)(() => PerfBook, { foreignKey: 'authorId' }),
    __metadata("design:type", Array)
], PerfAuthor.prototype, "books", void 0);
PerfAuthor = __decorate([
    (0, Entity_1.Entity)({ name: 'PerfAuthors' })
], PerfAuthor);
...
__decorate([
    (0, PrimaryKey_1.PrimaryKey)({ autoIncrement: true }),
    __metadata("design:type", Number)
], PerfBook.prototype, "id", void 0);
__decorate([
    (0, Column_1.Column)({ type: 'TEXT', nullable: false }),
    __metadata("design:type", String)
], PerfBook.prototype, "title", void 0);
__decorate([
    (0, Column_1.Column)({ type: 'INTEGER', nullable: false }),
    __metadata("design:type", Number)
], PerfBook.prototype, "authorId", void 0);
__decorate([
    (0, Relationships_1.ManyToOne)(() => PerfAuthor, { foreignKey: 'authorId' }),
    __metadata("design:type", PerfAuthor)
], PerfBook.prototype, "author", void 0);
PerfBook = __decorate([
    (0, Entity_1.Entity)({ name: 'PerfBooks' })
], PerfBook);
