...
describe('Decorators', () => {
  ...
  describe('@Entity', () => {
    it('should register entity metadata', () => {
      ...
      TestEntity = __decorate([(0, src_1.Entity)()], TestEntity);
    ...
    it('should use custom table name', () => {
      let TestEntity = class TestEntity {};
      TestEntity = __decorate([(0, src_1.Entity)({ name: 'custom_table' })], TestEntity);
      const metadata = MetadataStorage_1.MetadataStorage.getEntity(TestEntity);
  ...
  describe('Relationship decorators', () => {
    it('should register one-to-many relationship', () => {
      ...
      __decorate(
        [(0, src_1.OneToMany)(() => Post), __metadata('design:type', Array)],
        User.prototype,
        'posts',
        void 0
      );
      ...
      __decorate(
        [(0, src_1.ManyToOne)(() => User), __metadata('design:type', User)],
        Post.prototype,
        'user',
        void 0
      );
