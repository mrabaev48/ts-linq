...
describe('Specification', () => {
    ...
    it('Composite AND combines expressions', () => {
        ...
        const s1 = new Specification_1.PredicateSpecification((x) => x.a === 1, parser.parse((x) => x.a === 1));
        const s2 = new Specification_1.PredicateSpecification((x) => x.b > 0, parser.parse((x) => x.b > 0));
