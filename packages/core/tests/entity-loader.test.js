...
function createTestEntities() {
    ...
    ], LoaderUser.prototype, "id", void 0);
    __decorate([
        (0, src_1.Column)(),
        __metadata("design:type", String)
    ], LoaderUser.prototype, "name", void 0);
    __decorate([
        (0, src_1.OneToMany)(() => LoaderPost, { foreignKey: 'userId' }),
        __metadata("design:type", Array)
    ], LoaderUser.prototype, "posts", void 0);
    LoaderUser = __decorate([
        (0, src_1.Entity)()
    ], LoaderUser);
    ...
    __decorate([
        (0, src_1.PrimaryKey)({ autoIncrement: true }),
        __metadata("design:type", Number)
    ], LoaderPost.prototype, "id", void 0);
    __decorate([
        (0, src_1.Column)(),
        __metadata("design:type", String)
    ], LoaderPost.prototype, "title", void 0);
    __decorate([
        (0, src_1.Column)(),
        __metadata("design:type", Number)
    ], LoaderPost.prototype, "userId", void 0);
    __decorate([
        (0, src_1.ManyToOne)(() => LoaderUser, { foreignKey: 'userId' }),
        __metadata("design:type", LoaderUser)
    ], LoaderPost.prototype, "user", void 0);
    LoaderPost = __decorate([
        (0, src_1.Entity)()
    ], LoaderPost);
