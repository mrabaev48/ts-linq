...
__decorate(
  ...
  MetadataTestEntity.prototype,
  'id',
  void 0
);
__decorate(
  [(0, src_1.Column)({ nullable: false }), __metadata('design:type', String)],
  MetadataTestEntity.prototype,
  'name',
  void 0
);
...
__decorate(
  [(0, src_1.OneToMany)(() => MetadataRelatedEntity), __metadata('design:type', Array)],
  MetadataTestEntity.prototype,
  'related',
  void 0
);
MetadataTestEntity = __decorate([(0, src_1.Entity)()], MetadataTestEntity);
let MetadataRelatedEntity = class MetadataRelatedEntity {};
__decorate(
  [(0, src_1.PrimaryKey)(), __metadata('design:type', Number)],
  MetadataRelatedEntity.prototype,
  'id',
  void 0
);
__decorate(
  ...
  describe('entity registration', () => {
    it('should register entity with decorators', () => {
      ...
      const relatedEntityMetadata =
        MetadataStorage_1.MetadataStorage.getEntity(MetadataRelatedEntity);
