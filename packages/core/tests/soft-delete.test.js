...
function defineSUser() {
    ...
    ], SUser.prototype, "id", void 0);
    __decorate([
        (0, src_1.Column)({ type: 'TEXT', nullable: false }),
        __metadata("design:type", String)
    ], SUser.prototype, "name", void 0);
    __decorate([
        (0, src_1.Column)({ type: 'BOOLEAN', nullable: false, defaultValue: false }),
        __metadata("design:type", Boolean)
    ], SUser.prototype, "isDeleted", void 0);
    __decorate([
        (0, src_1.Column)({ type: 'DATETIME', nullable: true }),
        __metadata("design:type", Date)
    ], SUser.prototype, "deletedAt", void 0);
    __decorate([
        (0, src_1.Column)({ type: 'DATETIME', nullable: true }),
        __metadata("design:type", Date)
    ], SUser.prototype, "createdAt", void 0);
    __decorate([
        (0, src_1.Column)({ type: 'DATETIME', nullable: true }),
        __metadata("design:type", Date)
    ], SUser.prototype, "updatedAt", void 0);
    SUser = __decorate([
        (0, src_1.Entity)()
    ], SUser);
    return SUser;
