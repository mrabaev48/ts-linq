...
export interface DbContextOptions {
  ...
  /**
   * AOT-compiled model snapshot generated by `pnpm ts-linq dbcontext optimize`.
   * When set, DbContext pre-populates MetadataRegistry from this snapshot and skips
   * the reflective decorator scan on startup, reducing cold-start latency.
   * queryFilters and fluent overrides in onModelCreating still apply on top.
   */
  compiledModel?: import('@ts-linq/metadata').CompiledModel;
  /**
