...
exports.EnhancedSqlCache = void 0;
...
class EnhancedSqlCache {
    ...
    getCompressedKey(originalKey) {
        ...
        const hash = (0, node_crypto_1.createHash)('sha256').update(originalKey).digest('hex');
        const compressedKey = `hash_${hash.substring(0, 16)}`; // Use first 16 chars of hash
        return compressedKey;
    }
    isExpired(entry) {
        if (entry.ttl <= 0)
            return false; // No expiration for ttl <= 0
...
exports.EnhancedSqlCache = EnhancedSqlCache;
