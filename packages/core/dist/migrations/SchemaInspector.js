...
exports.MssqlSchemaInspector =
  exports.MySqlSchemaInspector =
  exports.PostgresSchemaInspector =
  exports.SQLiteSchemaInspector =
    void 0;
...
class SQLiteSchemaInspector {
  ...
  async getIndexes(table) {
    ...
    for (const row of list) {
      ...
      const sqlRows = await this.provider.executeQuery(
...
exports.SQLiteSchemaInspector = SQLiteSchemaInspector;
...
exports.PostgresSchemaInspector = PostgresSchemaInspector;
...
exports.MySqlSchemaInspector = MySqlSchemaInspector;
...
exports.MssqlSchemaInspector = MssqlSchemaInspector;
