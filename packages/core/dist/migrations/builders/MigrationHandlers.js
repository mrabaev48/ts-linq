...
exports.handleColumnRenames =
  exports.handleFkDrops =
  exports.handleIndexDrops =
  exports.buildCreateTableSql =
  exports.handleDropTable =
  exports.handleCreateTable =
  exports.handleTableRename =
  exports.buildDropFkSql =
  exports.buildAddFkSql =
  exports.buildInlineFkSql =
  exports.buildAlterNullSql =
  exports.buildAlterTypeSql =
  exports.buildDropColumnSql =
  exports.buildAddColumnSql =
  exports.renderColumn =
    void 0;
...
Object.defineProperty(exports, 'renderColumn', {
  enumerable: true,
  get: function () {
    return ColumnHandlers_2.renderColumn;
  }
});
Object.defineProperty(exports, 'buildAddColumnSql', {
  enumerable: true,
  get: function () {
    return ColumnHandlers_2.buildAddColumnSql;
  }
});
Object.defineProperty(exports, 'buildDropColumnSql', {
  enumerable: true,
  get: function () {
    return ColumnHandlers_2.buildDropColumnSql;
  }
});
Object.defineProperty(exports, 'buildAlterTypeSql', {
  enumerable: true,
  get: function () {
    return ColumnHandlers_2.buildAlterTypeSql;
  }
});
Object.defineProperty(exports, 'buildAlterNullSql', {
  enumerable: true,
  get: function () {
    return ColumnHandlers_2.buildAlterNullSql;
  }
});
var ForeignKeyHandlers_2 = require('./handlers/ForeignKeyHandlers');
Object.defineProperty(exports, 'buildInlineFkSql', {
  enumerable: true,
  get: function () {
    return ForeignKeyHandlers_2.buildInlineFkSql;
  }
});
Object.defineProperty(exports, 'buildAddFkSql', {
  enumerable: true,
  get: function () {
    return ForeignKeyHandlers_2.buildAddFkSql;
  }
});
Object.defineProperty(exports, 'buildDropFkSql', {
  enumerable: true,
  get: function () {
    return ForeignKeyHandlers_2.buildDropFkSql;
  }
});
var TableHandlers_1 = require('./handlers/TableHandlers');
Object.defineProperty(exports, 'handleTableRename', {
  enumerable: true,
  get: function () {
    return TableHandlers_1.handleTableRename;
  }
});
Object.defineProperty(exports, 'handleCreateTable', {
  enumerable: true,
  get: function () {
    return TableHandlers_1.handleCreateTable;
  }
});
Object.defineProperty(exports, 'handleDropTable', {
  enumerable: true,
  get: function () {
    return TableHandlers_1.handleDropTable;
  }
});
Object.defineProperty(exports, 'buildCreateTableSql', {
  enumerable: true,
  get: function () {
    return TableHandlers_1.buildCreateTableSql;
  }
});
...
Object.defineProperty(exports, 'handleIndexDrops', {
  enumerable: true,
  get: function () {
    return IndexHandlers_1.handleIndexDrops;
  }
});
...
Object.defineProperty(exports, 'handleFkDrops', {
  enumerable: true,
  get: function () {
    return ForeignKeyHandlers_3.handleFkDrops;
  }
});
...
function handleAddColumnChange(dialect, td, ch, up, down) {
  if (isComputedColumn(ch.column) || hasDefaultExpression(ch.column)) {
    ...
    up.push(
      (0, ColumnHandlers_1.buildAddColumnSql)(
        dialect,
        td,
        ch.column.name,
        ch.column.type,
...
function handleAlterColumnChange(dialect, td, ch, up) {
  if (isComputedChanged(ch.prev, ch.column)) {
    ...
    const kw = dialect === 'mssql' ? 'ADD' : 'ADD COLUMN';
    up.push(
      `ALTER TABLE ${(0, SqlUtils_1.q)(dialect, td.table)} ${kw} ${(0, ColumnHandlers_1.renderColumn)(dialect, ch.column)}`
    );
    return;
  }
  if (hasTypeChanged(ch.prev, ch.column)) {
    up.push(
      (0, ColumnHandlers_1.buildAlterTypeSql)(dialect, td.table, ch.column.name, ch.column.type)
    );
  }
  const prevNullable = ch.prev?.nullable;
  if (typeof prevNullable === 'boolean' && prevNullable !== ch.column.nullable) {
    up.push(
      (0, ColumnHandlers_1.buildAlterNullSql)(dialect, td.table, ch.column.name, ch.column.nullable)
    );
  }
}
...
Object.defineProperty(exports, 'handleColumnRenames', {
  enumerable: true,
  get: function () {
    return ColumnHandlers_3.handleColumnRenames;
  }
});
