 ...
 */
export type ColumnType = 'TEXT' | 'STRING' | 'INTEGER' | 'NUMBER' | 'REAL' | 'FLOAT' | 'DOUBLE' | 'BOOLEAN' | 'DATETIME' | 'DATE' | 'BLOB' | 'UUID' | 'JSON' | 'JSONB';
 ...
 */
export declare function unbrandId<T extends string | number, EntityName extends string>(id: EntityId<T, EntityName>): T;
/**
 * Brand a raw ID value for type safety.
 * Use this when receiving IDs from external sources.
 */
export declare function brandId<T extends string | number, EntityName extends string>(id: T): EntityId<T, EntityName>;
/**
 * Type predicate to check if a value is a valid branded ID.
 * Primarily for runtime validation and type narrowing.
 */
export declare function isBrandedId<T extends string | number, EntityName extends string>(value: unknown): value is EntityId<T, EntityName>;
/**
