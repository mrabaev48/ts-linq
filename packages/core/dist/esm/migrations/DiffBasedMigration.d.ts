...
export declare abstract class DiffBasedMigration extends Migration {
  ...
  protected beforeUp(_sqls: string[]): Promise<void>;
  /** Hook after executing all UP statements. */
  protected afterUp(_sqls: string[]): Promise<void>;
  /** Hook before executing a single UP statement; return false to skip. */
  protected beforeUpStatement(_sql: string): Promise<boolean>;
  /** Hook after executing a single UP statement. */
  protected afterUpStatement(_sql: string): Promise<void>;
  /** Hook before executing all DOWN statements. */
  protected beforeDown(_sqls: string[]): Promise<void>;
  /** Hook after executing all DOWN statements. */
  protected afterDown(_sqls: string[]): Promise<void>;
  /** Hook before executing a single DOWN statement; return false to skip. */
  protected beforeDownStatement(_sql: string): Promise<boolean>;
  /** Hook after executing a single DOWN statement. */
  protected afterDownStatement(_sql: string): Promise<void>;
  up(): Promise<void>;
  down(): Promise<void>;
}
