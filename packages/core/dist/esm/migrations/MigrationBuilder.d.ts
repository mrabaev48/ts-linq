...
export declare class MigrationBuilder {
  ...
  toDiff(): SchemaDiff;
  private collectCreates;
  private collectDrops;
  private ensureTableFactory;
  private collectColumnChanges;
  private collectIndexChanges;
  private collectForeignKeyChanges;
