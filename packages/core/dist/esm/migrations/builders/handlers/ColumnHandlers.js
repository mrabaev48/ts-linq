...
export function handleColumnRenames(td, dialect, up) {
...
export function renderColumn(dialect, c) {
...
export function buildAddColumnSql(dialect, td, name, type, nullable, def) {
...
export function buildDropColumnSql(dialect, table, name) {
...
export function buildAlterTypeSql(dialect, table, name, newType) {
...
export function buildAlterNullSql(dialect, table, name, nullable) {
  const tableName = q(dialect, table);
  const columnName = q(dialect, name);
  switch (dialect) {
    case 'postgresql':
