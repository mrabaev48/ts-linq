    ...
    async maybeAnalyzeQuery(info) {
        ...
        if (needExplain) {
            try {
                ...
                (0, InternalLogger_1.logInternalError)('DatabaseProvider.maybeAnalyzeQuery.explain', e);
            }
        }
            ...
            if (this.middlewares && this.middlewares.length > 0) {
                for (const mw of this.middlewares) {
                    try {
                        ...
                        (0, InternalLogger_1.logInternalError)('DatabaseProvider.maybeAnalyzeQuery.middleware', e);
                    }
                }
            }
        }
        catch (e) {
            (0, InternalLogger_1.logInternalError)('DatabaseProvider.maybeAnalyzeQuery.logger', e);
        }
    }
    ...
    preCheckCircuit() {
        ...
        if (this.circuitState === 'open') {
            ...
            if (now - openSince < openDuration) {
                throw new types_1.CircuitOpenError();
            }
        ...
        if (this.circuitState === 'half-open') {
            ...
            if (this.halfOpenInFlight >= maxProbes) {
                throw new types_1.CircuitOpenError('Half-open probes limit reached');
            }
    ...
    async beforeExecute(sql, params) {
        ...
        for (const mw of this.middlewares) {
            try {
                ...
                (0, InternalLogger_1.logInternalError)('DatabaseProvider.beforeExecute.middleware', e);
            }
        }
    }
    ...
    async afterExecute(sql, params, result) {
        ...
        for (const mw of this.middlewares) {
            try {
                ...
                (0, InternalLogger_1.logInternalError)('DatabaseProvider.afterExecute.middleware', e);
            }
        }
    }
    ...
    async notifyEntityMaterialized(entity, metadata) {
        ...
        for (const mw of this.middlewares) {
            try {
                ...
                (0, InternalLogger_1.logInternalError)('DatabaseProvider.notifyEntityMaterialized.middleware', e);
            }
        }
    }
    /**
