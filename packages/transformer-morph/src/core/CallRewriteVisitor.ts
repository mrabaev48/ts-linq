...
/**
 * Canonical call-rewrite traversal behind {@link createWhereTransformer}. Ported
 * from `@ts-linq/transformer` (which keeps a ts-patch entrypoint variant); the
 * traversal, dispatch and the fragile chained-receiver re-rewrite live here once.
 */
