...
const MssqlDialect_1 = require('./MssqlDialect');
const MssqlDdlStrategy_1 = require('./MssqlDdlStrategy');
/**
...
class MssqlProvider extends core_1.DatabaseProvider {
  ...
  constructor(connectionString, logger, middlewares, softDelete, retryPolicy) {
    ...
    this.pool = null;
    this.tx = null;
    this.ddl = new MssqlDdlStrategy_1.MssqlDdlStrategy();
  ...
  getDialect() {
    return new MssqlDialect_1.MssqlDialect();
  }
  // Private helpers
