describe('MySQL Migrations + Dialect Integration', () => {
  describe('CREATE TABLE', () => {
    it.todo('should generate CREATE TABLE with AUTO_INCREMENT');
    ...
    it.todo('should generate CHECK constraint if supported');
  });

  describe('ALTER TABLE', () => {
    it.todo('should generate ADD COLUMN');
    it.todo('should generate DROP COLUMN');
    it.todo('should generate MODIFY COLUMN TYPE');
  ...
  describe('INDEXES', () => {
    it.todo('should generate CREATE INDEX (FULLTEXT/SPATIAL where supported)');
  });
});
