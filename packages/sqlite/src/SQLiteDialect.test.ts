...
describe('SQLiteDialect buildSelect parameterization', () => {
  beforeEach(() => {
    ...
    MetadataStorage.addColumn(TestUser, { propertyName: 'body', columnName: 'body', type: 'TEXT', nullable: false });
    MetadataStorage.addColumn(TestUser, { propertyName: 'payload', columnName: 'payload', type: 'JSON', nullable: true });
