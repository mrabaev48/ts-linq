...
export declare class Queryable<T> {
     ...
     */
    constructor(entityClass: new () => T, provider: DatabaseProvider, entityLoader?: EntityLoader, entityCache?: EntityCacheLike, performance?: PerformanceOptions, globalFilters?: GlobalFilter[]);
     ...
     */
    innerJoin<TOther>(otherCtor: new () => TOther, on: (left: T, right: TOther) => boolean, alias?: string): Queryable<T>;
    /**
     ...
     * @param alias Optional alias for the joined table
     */
    leftJoin<TOther>(otherCtor: new () => TOther, on: (left: T, right: TOther) => boolean, alias?: string): Queryable<T>;
    /**
     ...
     */
    keysetPaginate<TKey extends keyof T>(key: TKey, after: T[TKey] | null, size: number): Promise<{
        items: T[];
        pageSize: number;
