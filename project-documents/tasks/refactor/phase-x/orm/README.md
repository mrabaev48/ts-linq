...
| 8 | task-8.md — Reduce `as unknown as` casts in DbSet factory | P2 | ✅ Completed | Type-safety erosion |

> **Package status: ✅ Complete** — task-1, task-2, task-3, task-4, task-5, task-6, task-6.1, task-7, task-8 ✅ done. All refactor tasks for `@ts-linq/orm` are landed.
